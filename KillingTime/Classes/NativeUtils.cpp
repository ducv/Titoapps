...
#define CLASS_NAME "com/tito/crazy/jump/utils/NativeUtils"
#endif
...
void NativeUtils::screenCapture()
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniHelpers::jniCommonVoidCall(
		"screenCapture",
